...
/**
 * Base class for Integration Tests accessing Hono Telemetry and Event APIs.
 */
public abstract class AmqpTelemetryAndEventTestBase extends AmqpAdapterTestBase {
     ...
     */
    protected Future<ProtonSender> setupProtocolAdapter(final String tenantId, final String deviceId, final boolean disableTenant) {
