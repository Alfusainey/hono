...
/**
 * Base class for integration tests verifying that devices can upload messages (telemetry and/or events) to the AMQP
 * adapter.
 *
 */
public abstract class GeneralAmqpIT extends AmqpAdapterTestBase {
